...
class MessageLabels {
  ...
  get email_format_field => _EMAIL_FORMAT_FIELD_LOGIN;

  get auth_fail_content => _AUTHENTICATION_FAIL_CONTENT;

  get opss_fail_title => _OPSS_TITLE;

  get elev_not_found_yet => _ELEVATORS_NOT_FOUND_YET;

  get confirmation => _ELEVATORS_ACTIVATION_CONFIRMATION;

  get error_update_try_again => _ELEVATORS_ERROR_UPDATE_TRY_AGAIN;
